...
{
    public partial class FormTranslations : FHFormTab
    {
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            if (txtLanguage.Text != "")
            {
                mGridDataSource = Common.Localization.GetFormTranslationsByForm
                                    (txtForm.Text, txtLanguage.Text, chbOnlyNotTranslated.Checked);
